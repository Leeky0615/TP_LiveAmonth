...
<body>
      <div class="mar-btm">
         ...
         <p class="text-muted text-sm"> ${param.scheduleReplyDate} </p>
      </div>
      ...
      <c:if test = "${param.checkScheduleReplyRefNO == null}">
          <div class="pad-ver">
             <button id = "replyButton" class="btn btn-sm btn-default btn-hover-primary" onclick="showReplyDiv(${param.scheduleReplyNO});">Comment</button>
          </div>
          <hr>
