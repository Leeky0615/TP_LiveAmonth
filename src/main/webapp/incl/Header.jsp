			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9">
						<nav class="nav-menu">
							<ul>
								<li class="active"><a href="./index.html">어디서?</a>
									<ul class="dropdown">
								...
								<li><a href="#">무엇을?</a></li>
								<li><a href="./agents.html">얼마나 들까?</a></li>
								<li class="active"><a href="./index.html">다른사람들은?</a>
									<ul class="dropdown">
										<li><a href="*">ALL</a></li>
										<li><a href="*">BEST 후기게시판</a></li>
										<li><a href="*">후기 게시판</a></li>
									</ul>
								</li>
								<li><a href="schedule">스케줄표</a></li>
							</ul>
						</nav>
					</div>
					<div class="col-lg-3">
